...
void RE::genStateTree() {
    ...
    StateInfo si;
    si.name = "leaf";
    si.states.push_back("int state;");
    stateTree->push_back(si);
}

// emitDataStructure
//void RE::emitDataStructure(ostream& out) {
//    for (auto revIt = stateTree->rbegin(); revIt = stateTree->rend(); revIt++) {
//	out << revIt->state
//    }
//}
...
//
//
//// emitDataStructureType
//
//// emit code for update
